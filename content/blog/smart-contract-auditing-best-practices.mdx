...
✅ Audits completed <12 months ago
...
**If <6 checked:** Do not integrate (too risky)
...
4. **No test coverage** (<80% coverage) = 🚩
5. **Forked code without audit** = 🚩
6. **New deployment** (<3 months live, <$10M TVL) = 🚩
